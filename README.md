...
### Пример
Пользователь 1 создает ордер: купить 300 RUB за USDT по цене 0.015 USDT за 1 RUB.
- С баланса списывается: 300 × 0.015 = 4.5 USDT

Пользователь 2 создает ордер: продать 200 RUB за USDT по цене 0.01 USDT за 1 RUB.
- Сделка выполняется по цене 0.01 (цена продавца)
- Пользователь 1: +200 RUB, -2 USDT
- Пользователь 2: -200 RUB, +2 USDT
